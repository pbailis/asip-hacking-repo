...
SHORT_ALGORITHMS = ["HOGWILD", "PORKCHOP", "ADMM"] # ["PORKCHOP",  "ADMM", "HOGWILD"] # "ADMM", "PORKCHOP"]#, "PORKCHOP", "HOGWILD"]#, "PORKCHOP"]#"PORKCHOP", "ADMM"]
SHORT_RUNTIMES = [2*1000, 10*1000]
SHORT_TASKS = [("SVM", "L2")]
